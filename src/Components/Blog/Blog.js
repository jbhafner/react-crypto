					...
					<div class="wrap">
					  <div class="post">
					    ...
					    <article>
					      ...
					      <br/>
					        <blockquote>Bitcoins can be used to buy merchandise anonymously. In addition, international payments are easy and cheap because bitcoins are not tied to any country or subject to regulation. Small businesses may like them because there are no credit card fees. Some people just buy bitcoins as an investment, hoping that they’ll go up in value.</blockquote>  
					...
					<div class="wrap">
					  <div class="post">
					    ...
					    <article>
					      ...
					      <br/>
					        <blockquote>Buy on an Exchange. Many marketplaces called “bitcoin exchanges” allow people to buy or sell bitcoins using different currencies. Coinbase is a leading exchange, along with Bitstamp and Bitfinex. But security can be a concern: bitcoins worth tens of millions of dollars were stolen from Bitfinex when it was hacked in 2016.</blockquote> 
					        <blockquote>Transfers
					        People can send bitcoins to each other using mobile apps or their computers. It’s similar to sending cash digitally.</blockquote>
					        <blockquote>Mining
					        People compete to “mine” bitcoins using computers to solve complex math puzzles. This is how bitcoins are created. Currently, a winner is rewarded with 12.5 bitcoins roughly every 10 minutes.</blockquote>
					...
					<div class="wrap">
					  <div class="post">
					    ...
					    <article>
					      ...
					      <br/>
					        <blockquote>Bitcoins are stored in a “digital wallet,” which exists either in the cloud or on a user’s computer. The wallet is a kind of virtual bank account that allows users to send or receive bitcoins, pay for goods or save their money. Unlike bank accounts, bitcoin wallets are not insured by the FDIC.</blockquote>
					        <blockquote>Wallet in cloud: Servers have been hacked. Companies have fled with clients’ Bitcoins.</blockquote>  
					        <blockquote>Wallet on computer: You can accidentally delete them. Viruses could destroy them.</blockquote>
					...
					<div class="wrap">
					  <div class="post">
					    ...
					    <article>
					      ...
					      <br/>
					        <blockquote>Though each bitcoin transaction is recorded in a public log, names of buyers and sellers are never revealed – only their wallet IDs. While that keeps bitcoin users’ transactions private, it also lets them buy or sell anything without easily tracing it back to them. That’s why it has become the currency of choice for people online buying drugs or other illicit activities.</blockquote>
					...
					<div class="wrap">
					  <div class="post">
					    ...
					    <article>
					      ...
					      <br/>
					        <blockquote>No one knows what will become of bitcoin. It is mostly unregulated, but some countries like Japan, China and Australia have begun weighing regulations. Governments are concerned about taxation and their lack of control over the currency.</blockquote>
